...
public sealed record UpdateOrganizationPickupStationLocationCommand(
    Guid OrganizationId,
    Guid ClaimId,
    decimal Latitude,
    decimal Longitude,
    ...
    string HouseNumber,
    string ZipCode,
    string City) : IRequest<OrganizationPickupStationResponse>;

public sealed class UpdateOrganizationPickupStationLocationCommandHandler
    : IRequestHandler<UpdateOrganizationPickupStationLocationCommand, OrganizationPickupStationResponse>
{
    ...
    public UpdateOrganizationPickupStationLocationCommandHandler(
    ...
    public async Task<OrganizationPickupStationResponse> Handle(
        UpdateOrganizationPickupStationLocationCommand command,
        CancellationToken cancellationToken)
    {
        ...
        claim.UpdateLocation(Location.Create(
            command.Latitude,
            command.Longitude,
            command.Address,
            command.HouseNumber,
